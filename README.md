...
1. // step 1
สร้าง Field หรือ สนาม เพื่อใช้ในการเล่นเกม โดยเราจะใช้ Array แบบ 2 มิติ
2. // step 2
สร้างจุดเกิด ของ ตัวละคร(*), หมวก(^) , และ หลุม(0) **จุดเกิดยังมีโอกาสทับกันในบางเกม
3. // step 3
สร้างเงื่อนไขการเดิน โดยใช้ปุ่ม w:ขึ้น s:ลง a:ซ้าย d:ขวา เหมือนการเล่นเกมอื่นๆ
4. // step 4
สร้างเงื่อนไขในการตรวจสอบ สถานะการเดิน ได้แก่
- การเดินตกขอบ => แพ้
- การเดินไปเจอหลุม => แพ้
- การเดินไปเจอหมวก => ชนะ
5. // step 5
สร้างการอัพเดทการเดินทางของตัวละคร โดยแสดงผลตำแหน่งปัจจุบัน
6. // step 6
สร้าง Prompt ในการเล่นเกมใน terminal
7. // step 7
มีการ print สนาม ในการเล่นแต่ละครั้ง
